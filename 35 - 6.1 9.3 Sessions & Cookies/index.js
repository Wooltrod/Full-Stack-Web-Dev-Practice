...
import { Strategy } from "passport-local"; //authenticating login sessions in passport
...
/*passport can automatically grab information on username 
& password from our login form ("login.ejs") using 
the verify function, therefore no need of using body parser*/
